...
<html lang="en">
  ...
  <body >
    ...
    <button style="margin-left: 15px;" > <a href="{{route('index')}}">Index</a></button>
   <a style="margin-left: 20px;">Profile: {{auth('client')->user()->name}} </a>

<br> </br>
        <h1> List of my Url Shortend Link</h1>
        ...
        <tr>
            ...
            <td> <a href="{{route('code.shortlink',$shortlink->code)}}" target="_blank"> {{route('code.shortlink',$shortlink->code)}} </a> </td>
